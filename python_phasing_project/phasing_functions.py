...
def edge_detection(sample_size, estimated_start_index, estimated_end_index, paternal_rd_array, maternal_rd_array, vcf_pos):
    ...
    if not estimated_start_index and is_mosaicism_to_the_end:
        ...
        return [vcf_pos[0], vcf_pos[final_index]]
        ...
        return [vcf_pos[0], vcf_pos[center_index + filter_difference.index(min_val)]]
        ...
        # TODO: debug
        filter_start_difference = []
        for i in range(sample_size):
            curr_subarray = diff_arr[center_start_index - filter_width_one_side + i:center_start_index + filter_width_one_side + i]
            print(curr_subarray.size)
        ...
        #return [vcf_pos[center_start_index + filter_start_difference.index(min_start_val)],vcf_pos[center_end_index + filter_end_difference.index(min_end_val)]]
